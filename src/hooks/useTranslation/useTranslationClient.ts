...
import { defaultNS, getOptions, languages } from '@my-portfolio/i18n'
...
export function useTranslationClient(lng?: string, options?: UseTranslationOptions<string> & { ns?: string }) {
